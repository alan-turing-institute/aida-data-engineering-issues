## This is the original Tundra Team cleaning script, slightly modified to work in our repository
## It expectes to be run from the top level directory of the repo and to find its inputs in the standard location
...
# Modified by Giovanni Colavizza <gcolavizza@turing.ac.uk>
# June, July 2018
...
# Load data ----
load("../datasets/data_raw/teamtraits_AllTraits_AllObs_WideFormat.RData")
head(teamtraits)
...
teamtraits.long<-melt(teamtraits[,c("IndividualID","AccSpeciesName","OriginalName","SLA","PlantHeight_Veg","PlantHeight_Reproductive","SeedMass_dry","LeafN","LDMC","StemSpecificDensity","LeafP","LeafArea","LeafFreshMass","LeafDryMass","StemDiameter","Leaf.d15N","Leaf.d13c","LeafC","LCID","C.N.ratio","RSratio","RootingDepth","Lat","Lon","Altitude","SiteName","SubsiteName","Treatment","DOY_measured","Year_measured","DataContributor","Data_coPIs","File.name","Comments","ValueKindName","DataEnterer")],
                      id=c("IndividualID","AccSpeciesName","OriginalName","Lat","Lon","Altitude","SiteName","SubsiteName","Treatment","DOY_measured","Year_measured","DataContributor","Data_coPIs","File.name","Comments","ValueKindName","DataEnterer"),
                      na.rm = TRUE)
head(teamtraits.long)
nrow(teamtraits.long) # 75296 rows in long form, without NAs
...
save(ttt.save, file = "../datasets/data_clean/TTT_cleaned_dataset.RData")
write.csv(ttt.save, file = "../datasets/data_clean/TTT_cleaned_dataset.csv")
